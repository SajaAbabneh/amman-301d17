...
let secondSum = (a,b,c,d) => a+b+c+d;
console.log('sum',secondSum(1,2,3,4));
...
let objectLLit = () => ({ key1: 'value1',key2: 'value2', key3: 'value3',})
console.log(objectLLit());
...
// let student = (namee,agee,hometownn) => {this.name = name;
//   this.age = age;
//   this.hometown = hometown;}

//   let joee = new student('Joe', 'Schmoe', 100);
//   console.log(joee);
